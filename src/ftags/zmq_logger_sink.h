...
{
public:
   ZmqPublisher(const std::string& name, const std::string& connectionString);
...
{
public:
   ZmqLoggerSink(const std::string& name, const std::string& connectionString) :
      m_publisher{name, connectionString}
   {
   }
